...
{
    public partial class JcwChartMdiFrm : XtraForm, IJcwChartFrm
    {
        ...
        public JcwChartMdiFrm()
            : this (new ChartMetadata (), DisplayOptions.None)
        {
        }

        public JcwChartMdiFrm(DisplayOptions displayOptions)
            : this (new ChartMetadata (), displayOptions)
        {
        }

        public JcwChartMdiFrm(ChartMetadata metadata, DisplayOptions displayOptions)
            : this (metadata, displayOptions, null)
        {
        }

        public JcwChartMdiFrm(ChartMetadata metadata, DisplayOptions displayOptions, IJcwCustomizeChart customizer)
            : base ()
        {
        ...
        [Browsable (false)]
        public DisplayOptions ChartDisplayOptions
        {
        ...
        public bool DisplayChartMetadataDockingPanel
        {
            ...
            {
                return
                    (ChartDisplayOptions & DisplayOptions.ShowMetadataControlOnDockingPanel) ==
                        DisplayOptions.ShowMetadataControlOnDockingPanel ||
                    (ChartDisplayOptions & DisplayOptions.ShowSaveableMetadataControlOnDockingPanel) ==
        ...
        public bool CanSaveChartMetadata
        {
            get
            {
                return (ChartDisplayOptions & DisplayOptions.ShowSaveableMetadataControlOnDockingPanel) ==
                    DisplayOptions.ShowSaveableMetadataControlOnDockingPanel;
            }
        }
        ...
        {
            get { return (ChartDisplayOptions & DisplayOptions.ShowHotSpots) == DisplayOptions.ShowHotSpots; }
            set
            {
                if (value)
                {
                    ChartDisplayOptions |= DisplayOptions.ShowHotSpots;
                }
                else
                {
                    ChartDisplayOptions &= ~DisplayOptions.ShowHotSpots;
