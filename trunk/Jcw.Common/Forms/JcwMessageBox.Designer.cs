namespace Jcw.Common.Forms
{
    partial class JcwMessageBox
    {
        ...
        {
            this.CancelButton = new Jcw.Common.Controls.JcwSafeButton ();
            this.NoButton = new Jcw.Common.Controls.JcwSafeButton ();
            this.OkButton = new Jcw.Common.Controls.JcwSafeButton ();
            this.YesButton = new Jcw.Common.Controls.JcwSafeButton ();
        ...
        new private Jcw.Common.Controls.JcwSafeButton CancelButton;
        private Jcw.Common.Controls.JcwSafeButton NoButton;
        private Jcw.Common.Controls.JcwSafeButton OkButton;
        private Jcw.Common.Controls.JcwSafeButton YesButton;
